	...
	<section class="py-20 px-6 border-y-2 border-red-500/30 bg-red-500/5">
		<div class="max-w-3xl mx-auto">
			<div class="text-center mb-8">
				<h2 class="text-3xl font-bold text-red-400 mb-4">⚠ This is not a game</h2>
			</div>
...
TOP 10 HOLDERS: 42.3%
DEV WALLET: 8.2% <span class="text-yellow-400">⚠</span>
		...
		<div class="max-w-6xl mx-auto">
			<div class="grid md:grid-cols-4 gap-8 mb-8 text-sm">
				...
				<div>
					...
					<div class="space-y-2 text-crt-green/60">
						<a href="/terminal" class="block hover:text-crt-green">Launch Terminal</a>
					</div>
				</div>
			</div>
